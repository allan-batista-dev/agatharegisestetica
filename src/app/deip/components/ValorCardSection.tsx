        ...
        <section className=" py-32 bg-default flex justify-center">
            <Card className="mx-5 lg:mx-0 w-full lg:w-1/3 rounded-2xl px-5 py-10 text-center space-y-5 ">
                ...
                <p className="text-muted-foreground">
                    O passo a passo completo para oferecer tratamentos personalizados que geram resultados surpreendentes.
                </p>
                ...
                <p>
                HOJE VOCÊ TERÁ ACESSO A TUDO ISSO POR...
                </p>
                <p>
                    De R$997,90 por:
                </p>
                <p >
                    ...
                    <span className="text-5xl">R$60,03</span>
                </p>
                <p>
                    Ou R$597,90 à vista
                </p>
                ...
                <p>
                    O investimento mensal é menor do que o valor de uma única sessão de detox corporal, garantindo retorno financeiro rápido e seguro. Invista em seu crescimento e transforme sua carreira na estética hoje mesmo
                </p>
            </Card>
        </section>
    )
